...
setup(name='docassemble.FinalDc84AffidavitAndClaimSm',
      version='1.0',
      ...
      zip_safe=False,
      package_data=find_package_data(where='docassemble/FinalDc84AffidavitAndClaimSm/', package='docassemble.FinalDc84AffidavitAndClaimSm'),
     )
